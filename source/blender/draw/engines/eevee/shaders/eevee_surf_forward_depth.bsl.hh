 ...
 * 与 surf_forward 相同，但去掉 early_fragment_tests，允许材质 GLSL（node_set_depth）
...
struct SurfaceForwardDepth {
  [[legacy_info]] ShaderCreateInfo eevee_geom_iface_info;

  [[legacy_info]] ShaderCreateInfo draw_view_culling;
};

struct SurfaceForwardDepthFragOut {
...
[[fragment]]
void surf_forward_depth([[resource_table]] PipelineConstants & /*pipe*/,
                        [[resource_table]] SurfaceForwardDepth & /*srt*/,
                        ...
                        [[out]] SurfaceForwardDepthFragOut &frag_out,
