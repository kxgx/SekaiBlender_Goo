...
enum eSceneEEVEE_Flag : int {
  ...
  SCE_EEVEE_FSR_VIEWPORT = (1 << 29),
  SCE_EEVEE_FSR_RENDER = (1 << 30),
};
...
enum eSceneEEVEE_FSRQuality : int {
  SCE_EEVEE_FSR_QUALITY_ULTRA = 0,
  SCE_EEVEE_FSR_QUALITY_QUALITY = 1,
  SCE_EEVEE_FSR_QUALITY_BALANCED = 2,
  SCE_EEVEE_FSR_QUALITY_PERFORMANCE = 3,
};
