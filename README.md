<div align="center">
  ...
  <p>
    <a href="https://github.com/kxgx/SekaiBlender_Goo/releases/latest"><img src="https://img.shields.io/github/v/release/kxgx/SekaiBlender_Goo?style=flat-square&display_name=release&label=release&color=16a34a" alt="Latest release"></a>
    <a href="https://github.com/kxgx/SekaiBlender_Goo/blob/main/COPYING"><img src="https://img.shields.io/badge/license-GPL--2.0%2B-2563eb?style=flat-square" alt="GPL-2.0+"></a>
...
```powershell
git clone --recurse-submodules https://github.com/kxgx/SekaiBlender_Goo.git
cd SekaiBlender_Goo
git lfs install
git lfs pull
