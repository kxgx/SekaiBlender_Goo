...
class TOPBAR_MT_file_import(Menu):
    ...
    def draw(self, _context):
        ...
        if bpy.app.build_options.io_pmx:
            self.layout.operator("wm.pmx_import", text="PMX (.pmx)")
            self.layout.operator("wm.vmd_import", text="VMD (.vmd)")
            self.layout.operator("wm.vmd_camera_import", text="VMD Camera (.vmd)")
...
class TOPBAR_MT_file_export(Menu):
    ...
    def draw(self, _context):
        ...
        if bpy.app.build_options.io_pmx:
            self.layout.operator("wm.pmx_export", text="PMX Model (.pmx)")
            self.layout.operator("wm.vmd_export", text="VMD Motion (.vmd)")
            self.layout.operator("wm.vmd_camera_export", text="VMD Camera (.vmd)")
