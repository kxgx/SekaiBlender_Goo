...
class RENDER_PT_context(Panel):
    ...
    def draw(self, context):
        ...
        if context.engine in {'BLENDER_EEVEE', 'BLENDER_GOOENGINE'}:
            ...
            col = layout.column()
            col.prop(props, "use_fsr_viewport", text="Viewport")
            col.prop(props, "use_fsr_render", text="Render")

            col = layout.column()
            col.active = props.use_fsr_viewport or props.use_fsr_render
            col.prop(props, "fsr_quality", text="Quality")
            col.prop(props, "fsr_sharpness", text="Sharpness")
...
class RENDER_PT_eevee_performance_memory(RenderButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        layout.prop(props, "shadow_pool_size", text="Initial Shadow Pool")
